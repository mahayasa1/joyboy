...
<div class="bg-white shadow rounded-lg p-6 max-w-3xl mx-auto">
    ...
    <form action="{{ route('barang_masuk.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label class="block text-gray-700">ID Transaksi*</label>
                <input type="text" name="kode_transaksi" class="w-full border rounded px-3 py-2" placeholder="A001" required>
            </div>
            <div>
        ...
        <div class="flex gap-3 mt-6">
            ...
            <a href="{{ route('barang_masuk.index') }}" class="bg-gray-400 hover:bg-gray-500 text-white px-6 py-2 rounded">Batal</a>
        </div>
    </form>
</div>
@endsection
